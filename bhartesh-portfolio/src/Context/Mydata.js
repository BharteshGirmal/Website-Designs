...
export const technologies = [
  ...
  {
    name: "Redux",
    icon: "fab fa-react fa-3x text-primary",
    color: "text-green",
  },
  {
    name: "TypeScript",
    icon: "fas fa-code fa-3x text-blue",
    color: "text-green",
  },
  {
    name: "GraphQL",
  ...
  {
    name: "Node.js",
    icon: "fab fa-node-js fa-3x text-success",
    color: "text-green",
  },
  {
    name: "Python",
  ...
  {
    name: "MongoDB",
    icon: "fas fa-leaf fa-3x text-green",
    color: "text-green",
  },
  {
    name: "MySQL",
    icon: "fas fa-database fa-3x text-info",
    color: "text-green",
  },
  {
    name: "Docker",
